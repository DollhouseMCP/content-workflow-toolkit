# Content Workflow Toolkit - Commercial License

> **Important Legal Notice**: This document describes our commercial licensing program but does not itself constitute a binding commercial license. Commercial licenses require a separate written agreement negotiated on a case-by-case basis. Until such an agreement is executed, all use of Content Workflow Toolkit is governed exclusively by AGPL-3.0 terms as stated in the [LICENSE](./LICENSE) file.

Content Workflow Toolkit is part of the DollhouseMCP™ project family.
...
### Q: How do contributions work with dual licensing?
